...
# Mock documents
documents = [
    {"title": "DataPizza Overview", "content": "DataPizza è un'azienda innovativa che sviluppa soluzioni AI avanzate per l'analisi dei dati."},
    {"title": "Technical Tests", "content": "I test tecnici di DataPizza sono progettati per valutare le competenze dei candidati in scenari reali."},
    {"title": "AI Technologies", "content": "DataPizza usa technologie avanzate di AI per consegnare soluzioni innovative ai clienti."},
    {"title": "Company Culture", "content": "DataPizza fomenta una cultura di innovazione, collaborazione e apprendimento continuo."},
]
